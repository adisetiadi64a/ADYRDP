...
delayBox.Position = UDim2.new(0, 8, 0, 8)
...
delayLabel.Size = UDim2.new(0, 110, 0, 24)
delayLabel.Position = UDim2.new(0, 86, 0, 8)
...
startBox.Size = UDim2.new(0, 70, 0, 24)
startBox.Position = UDim2.new(0, 8, 0, 32)
...
startLabel.Size = UDim2.new(0, 110, 0, 24)
startLabel.Position = UDim2.new(0, 86, 0, 32)
startLabel.BackgroundTransparency = 1
startLabel.Text = "Start CP (number)"
...
note.Text = "Tip: Edit `teleportData` table to add more mountains."
